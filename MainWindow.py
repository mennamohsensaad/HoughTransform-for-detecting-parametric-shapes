...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Hough = QtWidgets.QTabWidget(self.centralwidget)
        self.Hough.setEnabled(True)
        self.Hough.setGeometry(QtCore.QRect(0, 0, 889, 449))
        self.Hough.setAutoFillBackground(True)
        ...
        self.Hough.addTab(self.tab_filters, "")
        ...
        self.Hough.addTab(self.tab_histograms, "")
        ...
        self.Hough.addTab(self.tab_hybrid, "")
        ...
        self.lineEdit_17.setGeometry(QtCore.QRect(60, 150, 101, 20))
        self.lineEdit_17.setObjectName("lineEdit_17")
        self.pushButton_filters_load_3 = QtWidgets.QPushButton(self.tab)
        self.pushButton_filters_load_3.setGeometry(QtCore.QRect(10, 40, 121, 81))
        self.pushButton_filters_load_3.setObjectName("pushButton_filters_load_3")
        self.label_24 = QtWidgets.QLabel(self.tab)
        self.label_24.setGeometry(QtCore.QRect(20, 150, 41, 21))
        self.label_24.setObjectName("label_24")
        self.lineEdit_18 = QtWidgets.QLineEdit(self.tab)
        self.lineEdit_18.setGeometry(QtCore.QRect(60, 200, 51, 31))
        self.lineEdit_18.setObjectName("lineEdit_18")
        self.label_filters_output_3 = QtWidgets.QLabel(self.tab)
        self.label_filters_output_3.setGeometry(QtCore.QRect(510, 40, 331, 231))
        self.label_filters_output_3.setAutoFillBackground(True)
        self.label_filters_output_3.setFrameShape(QtWidgets.QFrame.Box)
        self.label_filters_output_3.setTextFormat(QtCore.Qt.PlainText)
        self.label_filters_output_3.setScaledContents(True)
        self.label_filters_output_3.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.label_filters_output_3.setObjectName("label_filters_output_3")
        self.label_filters_input_3 = QtWidgets.QLabel(self.tab)
        self.label_filters_input_3.setGeometry(QtCore.QRect(170, 40, 331, 231))
        self.label_filters_input_3.setAutoFillBackground(True)
        self.label_filters_input_3.setFrameShape(QtWidgets.QFrame.Box)
        self.label_filters_input_3.setScaledContents(True)
        self.label_filters_input_3.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.label_filters_input_3.setObjectName("label_filters_input_3")
        self.groupBox_5 = QtWidgets.QGroupBox(self.tab)
        self.groupBox_5.setGeometry(QtCore.QRect(20, 310, 751, 111))
        self.groupBox_5.setObjectName("groupBox_5")
        self.horizontalLayoutWidget_5 = QtWidgets.QWidget(self.groupBox_5)
        self.horizontalLayoutWidget_5.setGeometry(QtCore.QRect(10, 40, 311, 41))
        ...
        self.groupBox_6.setGeometry(QtCore.QRect(380, 30, 311, 71))
        self.groupBox_6.setObjectName("groupBox_6")
        self.Harris_ApplyButton = QtWidgets.QPushButton(self.tab)
        self.Harris_ApplyButton.setGeometry(QtCore.QRect(30, 250, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.Harris_ApplyButton.setFont(font)
        self.Harris_ApplyButton.setObjectName("Harris_ApplyButton")
        self.Hough.addTab(self.tab, "")
        self.tab_3 = QtWidgets.QWidget()
        self.tab_3.setObjectName("tab_3")
        self.label_36 = QtWidgets.QLabel(self.tab_3)
        self.label_36.setGeometry(QtCore.QRect(20, 140, 41, 21))
        self.label_36.setObjectName("label_36")
        self.label_filters_output_4 = QtWidgets.QLabel(self.tab_3)
        self.label_filters_output_4.setGeometry(QtCore.QRect(510, 30, 331, 231))
        self.label_filters_output_4.setAutoFillBackground(True)
        ...
        self.label_filters_output_4.setScaledContents(True)
        ...
        self.pushButton_filters_load_4 = QtWidgets.QPushButton(self.tab_3)
        self.pushButton_filters_load_4.setGeometry(QtCore.QRect(10, 30, 121, 81))
        self.pushButton_filters_load_4.setObjectName("pushButton_filters_load_4")
        self.lineEdit_20 = QtWidgets.QLineEdit(self.tab_3)
        self.lineEdit_20.setGeometry(QtCore.QRect(60, 190, 51, 31))
        self.lineEdit_20.setObjectName("lineEdit_20")
        self.label_filters_input_4 = QtWidgets.QLabel(self.tab_3)
        self.label_filters_input_4.setGeometry(QtCore.QRect(170, 30, 331, 231))
        self.label_filters_input_4.setAutoFillBackground(True)
        self.label_filters_input_4.setFrameShape(QtWidgets.QFrame.Box)
        self.label_filters_input_4.setScaledContents(True)
        ...
        self.groupBox_7.setGeometry(QtCore.QRect(20, 300, 751, 111))
        self.groupBox_7.setObjectName("groupBox_7")
        self.groupBox_8 = QtWidgets.QGroupBox(self.groupBox_7)
        self.groupBox_8.setGeometry(QtCore.QRect(380, 30, 311, 71))
        self.groupBox_8.setObjectName("groupBox_8")
        self.label_40 = QtWidgets.QLabel(self.tab_3)
        self.label_40.setGeometry(QtCore.QRect(20, 190, 31, 21))
        self.label_40.setObjectName("label_40")
        self.lineEdit_22 = QtWidgets.QLineEdit(self.tab_3)
        self.lineEdit_22.setGeometry(QtCore.QRect(60, 140, 101, 20))
        self.lineEdit_22.setObjectName("lineEdit_22")
        self.Hough_ApplyButton_2 = QtWidgets.QPushButton(self.tab_3)
        self.Hough_ApplyButton_2.setGeometry(QtCore.QRect(20, 240, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.Hough_ApplyButton_2.setFont(font)
        self.Hough_ApplyButton_2.setObjectName("Hough_ApplyButton_2")
        self.groupBox_9 = QtWidgets.QGroupBox(self.tab_3)
        self.groupBox_9.setGeometry(QtCore.QRect(40, 330, 311, 71))
        self.groupBox_9.setObjectName("groupBox_9")
        self.Hough.addTab(self.tab_3, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Hough.setTabText(self.Hough.indexOf(self.tab_filters), _translate("MainWindow", "Filters"))
        ...
        self.Hough.setTabText(self.Hough.indexOf(self.tab_histograms), _translate("MainWindow", "Histograms"))
        ...
        self.Hough.setTabText(self.Hough.indexOf(self.tab_hybrid), _translate("MainWindow", "Hybrid"))
        self.label_23.setText(_translate("MainWindow", "Size:"))
        self.pushButton_filters_load_3.setText(_translate("MainWindow", "Load Image"))
        self.label_24.setText(_translate("MainWindow", "Name:"))
        self.label_filters_output_3.setText(_translate("MainWindow", "Output image"))
        self.label_filters_input_3.setText(_translate("MainWindow", "Input image"))
        ...
        self.comboBox_5.setCurrentText(_translate("MainWindow", "Select"))
        self.comboBox_5.setItemText(0, _translate("MainWindow", "Select"))
        self.comboBox_5.setItemText(1, _translate("MainWindow", "Lines"))
        self.comboBox_5.setItemText(2, _translate("MainWindow", "Circles"))
        self.groupBox_6.setTitle(_translate("MainWindow", "Additional  Tunable Parameters"))
        self.Harris_ApplyButton.setText(_translate("MainWindow", "Apply"))
        self.Hough.setTabText(self.Hough.indexOf(self.tab), _translate("MainWindow", "Hough"))
        self.label_36.setText(_translate("MainWindow", "Name:"))
        self.label_filters_output_4.setText(_translate("MainWindow", "Output image"))
        self.pushButton_filters_load_4.setText(_translate("MainWindow", "Load Image"))
        ...
        self.groupBox_8.setTitle(_translate("MainWindow", "Additional  Tunable Parameters"))
        self.label_40.setText(_translate("MainWindow", "Size:"))
        self.Hough_ApplyButton_2.setText(_translate("MainWindow", "Apply"))
        self.groupBox_9.setTitle(_translate("MainWindow", "Edg Detector  Tunable Parameters"))
        self.Hough.setTabText(self.Hough.indexOf(self.tab_3), _translate("MainWindow", "Harris"))
